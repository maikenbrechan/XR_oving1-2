...
public class CubeTranslation1 implements GLEventListener{
    ...
    public static void main(String[] args) {
        ...
        CubeTranslation1 cubeTranslation1 = new CubeTranslation1();
        glcanvas.addGLEventListener(cubeTranslation1);
        glcanvas.setSize(400, 400);

        //creating frame
        final JFrame frame = new JFrame ("Oppg3 translasjon 1");
